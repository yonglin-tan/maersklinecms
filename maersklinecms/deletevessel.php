	...
	<?php
		...
		if($resultCheck > 0) {
			...
			while($row = mysqli_fetch_assoc($result)) {
				echo '
				<form action="includes/deletevessel.inc.php" method="POST">
				<tr>
				...
				<td><button class="button button2" type="submit" name="submit">Delete Vessel</button></td>
				</tr>
				</form>';
