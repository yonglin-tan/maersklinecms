...
<div class="maincontainer">
		...
		<h1>Add Vessel</h1>
			<form class="registerform" action="includes/addvessel.inc.php" method="POST">
				<input type="text" name="name" placeholder="Vessel Name"><br>
				<input type="text" name="space" placeholder="Space Available (by days)"><br>
				<button class="button button2" type="submit" name="submit">Add Vessel</button><br>
			</form>
